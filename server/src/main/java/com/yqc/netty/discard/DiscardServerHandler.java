...
public class DiscardServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(final ChannelHandlerContext ctx) {
        ...
        //
        // 比较起来，NIO 缓冲并没有提供一种简洁的方式来计算出消息内容的开始和结尾，
        // 除非你调用 flip 方法。当你忘记调用 flip 方法而引起没有数据或者错误数据被发送时，你会陷入困境。
        ...
        // 这意味着任何一个请求操作都不会马上被执行，因为在 Netty 里所有的操作都是异步的。举个例子下面的代码中在消息被发送之前可能会先关闭连接。
        //
        //
        //    Channel ch = ...;
